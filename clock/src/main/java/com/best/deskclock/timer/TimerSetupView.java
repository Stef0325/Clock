...
public class TimerSetupView extends LinearLayout implements View.OnClickListener,
    ...
    private NumberPicker numberPickerHH;
    private NumberPicker numberPickerMM;
    private NumberPicker numberPickerSS;
    ...
    // Initialize the extreme value for NumberPickers.
    public void initNumberPicker(){
         ...
         numberPickerMM.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
             @Override
             public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                 mInput[2] = picker.getValue();
                 mInputPointer ++;
                 updateTime();
                 if (mInputPointer == 0) {
                     updateFab();
        ...
        numberPickerHH.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            @Override
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                mInput[4] = picker.getValue();
                mInputPointer ++;
                updateTime();
                if (mInputPointer == 0) {
                    updateFab();
    ...
    // Using numberPicker to update time
